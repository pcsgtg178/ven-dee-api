...
// ============================================================================
// 1. ModalEditCustomer.tsx
// ============================================================================
const modalEditCustomerCode = `"use client";
...
fs.writeFileSync('d:/ven-dee/ven-dee-app/app/components/ModalEditCustomer.tsx', modalEditCustomerCode, 'utf8');
console.log('Created ModalEditCustomer.tsx');

// ============================================================================
// 2. ModalEditShift.tsx
// ============================================================================
const modalEditShiftCode = `"use client";
...
fs.writeFileSync('d:/ven-dee/ven-dee-app/app/components/ModalEditShift.tsx', modalEditShiftCode, 'utf8');
console.log('Created ModalEditShift.tsx');

// ============================================================================
// 3. ModalEditService.tsx
// ============================================================================
const modalEditServiceCode = `"use client";
...
fs.writeFileSync('d:/ven-dee/ven-dee-app/app/components/ModalEditService.tsx', modalEditServiceCode, 'utf8');
console.log('Created ModalEditService.tsx');
